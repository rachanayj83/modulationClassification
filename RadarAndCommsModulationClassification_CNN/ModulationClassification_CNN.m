...
percentTrainingSamples = 40;
percentValidationSamples = 30;
percentTestSamples = 30;
...
if trainNow == true
  ...
  trainedNet15SNR_1a = trainNetwork(rxTraining,rxTrainingLabel,modClassNet1,options);
else
...
rxTestPred = classify(trainedNet15SNR_1a,rxTest);
