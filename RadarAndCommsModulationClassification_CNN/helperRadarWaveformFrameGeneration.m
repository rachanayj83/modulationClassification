function helperRadarWaveformFrameGeneration()

%% Setup Simulation Parameters
% User defined parameters
Fs = 1e8; % Sampling frequency (Hz)
nSignalsPerMod = 10; % Number of signals per modulation type
...
frameStore = helperModClassFrameStore(...
  nSignalsPerMod*nummodTypes,spf,modTypes);
transDelay = 50;

%% Generate training data
idxW = 1;
for iM = 1:nummodTypes
    modType = modTypes(iM);
